# Battery_Pack_Solver/Xiao_2022_Energy_Pouch.py
#
...
cathode_attrs = {
    ...
    "Ma": 30e-3,  # g/cm2, areal mass of cathode film
    "Qa": 4.1,  # mAh/cm2, areal film capacity
    "Mv": 3.3,  # g/cm3, density of cathode
    "Lf": 91e-4,  # cm, thickness of film
    "d0": 8.9,  # cm, width of film
    "d1": 26.4,  # cm, length of film
    "Vavg": 3.6,  # V, Average Voltage of Electrode
    "Q": 132e3,  # mAh, Total capacity of the cell
}
al_foil_attrs = {
    "Description": "Al-foil",
    "desc": "c_cc",
...
anode_attrs = {
    ...
    "Ma": 13.0e-3,  # g/cm2, areal mass of anode film
...
pouch_cell_attrs = {
    ...
    "desc": "pc",
    "N": 70,  # number of layers. defined as number of double sided anodes.
    "EC": 2.5e-3,  # g/mAh, E/C Ratio, mass electrolyte per capacity
    "NP": 1.1,  # 1, N/P Ratio
    "Em": 264,  # mWh/g, Energy Density of Electrode Materials
    "components": {
