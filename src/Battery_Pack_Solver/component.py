...
class PouchCell(Component):
    ...
    def initialize_attributes(self):
        ...
        # If the dimesions of the cathode and anode are provided in the pouch cell dict,
        # it overrides the dimensions of the cathode and anode components,
        # and sets them to the same values for both the cathode and anode.
        ...
        self.equations += [
            ...
            # Total Cost of Inactive materials of Cell
            (
                "sum",
                (self.c, "D_in", "+"),
                (self.a, "D_in", "+"),
    ...
    def print(self, set="libatt"):
        ...
        # pprint(self._attributes, width=40, sort_dicts=False, indent=4)
            ...
            nn_list = [getattr(self.c, "N", np.nan), getattr(self.a, "N", np.nan), 1]
            mm_list = [
            ...
            # print(len_in)
            # print(mm_list)
            for i in [2, 3, 8 + len_in, 9 + len_in]:
                str_list[i] = (
